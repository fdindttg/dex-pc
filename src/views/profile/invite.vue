  ...
  <div class="profile-page">
    ...
    <div class="container">
      <!-- <div class="w-100 d-flex align-items-center mb-3 mt-4">
        ...
        <div class="border rounded-sm px-1 text-tips">
          {{ $t('profile.dividends', { name: 'Bekon', num: '30%' }) }}。
        </div>
      </div> -->
      <div class="row">
        <div class="col-12 mb-4">
          <div class="panel-box">
            <!-- <div class="heading d-flex justify-content-between aligin-items-center">
              <div>{{$t('profile.joinThePlan',{name:'Bekon'})}}</div>
              <div class="blue">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="panel-box">
            ...
            <div
              class="tab-content"
              style="height:273px;overflow-y:auto"
            ...
            <div class="tab-content">
              <ul>
                <li class="my-2">
                  ...
                  {{ $t('profile.equalInvitee') }}30%{{ $t('profile.fee') }}。
                </li>
                <li class="my-2">
                  2.
                  <span class="font-weight-bold">{{ $t('profile.handlingFeeDividend') }}</span>
                  {{ $t('profile.afterThat') }}10{{ $t('profile.follow') }}。
                </li>
                <li class="my-2">
                  <div>
                    3.
                  ...
                  <ul class="ml-3">
                    <li class="my-2">
                      3.1
                      <span class="font-weight-bold">{{ $t('profile.handlingFeeDividend') }}</span
                      >{{ $t('profile.activityStartTime') }}：2020{{ $t('profile.Y') }}5{{ $t('profile.M') }}9{{
                        $t('profile.D')
                      }}
                    </li>
                    <li class="my-2">
                      3.2
                      <span class="font-weight-bold">{{ $t('profile.handlingFeeDividend') }}</span
                      >{{ $t('profile.endTime') }}：{{ $t('profile.proceed') }}
                    </li>
                  </ul>
                </li>
                <li class="my-2">4. Bekon{{ $t('profile.atAnyTime', { name: 'Bekon' }) }}</li>
                <li class="my-2">5. Bekon{{ $t('profile.reservedRights') }}。</li>
                <li class="my-2">6. Bekon{{ $t('profile.canDecide', { name: 'Bekon', link: 'www.bekonex.com' }) }}.</li>
              </ul>
            </div>
          </div>
        </div>
