              ...
              <div class="step-group d-flex justify-content-center text-center">
                ...
                <div class="step">
                  ...
                  <div class="btn">
                    <button
                      type="button"
                      @click="$router.push('/profile/certification')"
      ...
      <div class="row">
        <div class="col-md-4 d-flex">
          ...
          <div class="panel-box bg-panel shadow-sm w-100">
            ...
            <div class="tab-content">
              <div class="min-height-50">{{ $t('profile.dividends', { name: 'Bekon', num: '30%' }) }}</div>
              <button
                type="button"
                class="bottom-left-btn btn btn-sm btn-primary rounded-pill"
                @click="$router.push('/profile/invite')"
              >
