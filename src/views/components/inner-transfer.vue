    ...
    <div class="tab-content">
      <form class="transfer-body">
        <div class="form-row">
          ...
          <div class="col-2 d-flex justify-content-center align-items-center" @click="swap">
        ...
        <div class="form-group">
          ...
          <div>
            <el-select v-model="form.coin_name" :placeholder="$t('wallet.pleaseSelect')">
              <el-option v-for="(item, index) in coinList" :key="index" :label="item.coin_name" :value="item.coin_name">
          ...
          <div class="input-group">
            ...
            <div class="input-group-append">
              <span class="input-group-text fn-12">
                {{ $t('wallet.balance') }}：
                <span class="fn-14">{{ activeCoin.usable_balance | omitTo(4) }}</span>
                &nbsp; {{ form.coin_name }}
              </span>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    swap() {
      ...
      let to_account = this.form.to_account
      this.fromValue = [to_account.toString()]
      this.fromChange()

      this.toValue = [from_account.toString()]
      this.toChange()
    },
