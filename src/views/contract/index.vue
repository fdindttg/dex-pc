        ...
        <div class="coin-change d-flex align-items-center py-2 pl-4 heading justify-content-between">
          <div class="d-flex align-items-center">
            <div class="coin d-flex align-items-center">
              <el-popover placement="bottom" ref="popover" width="400" trigger="click">
                ...
                <div class="markets-pair-list" style="max-height:300px;overflow:auto;">
                  <div v-for="(parent, index) in contractList" :key="index">
                    ...
                    <table class="table" :key="parent.coin_name + 1">
                      ...
                      <tbody>
                        ...
                        >
                          <td class="w-10/24">{{ item.symbol }}/{{ parent.coin_name }}</td>
                          <td class="w-7/24 " :class="item.increase < 0 ? 'decreace' : 'increase'">
                            {{ item.price }}
                          </td>
                          <td class="w-7/24" :class="item.increase < 0 ? 'decreace' : 'increase'">
                            {{ item.increaseStr }}
            ...
            <div class="d-flex fn-12">
              ...
              <div class="item px-2">
                <div class="title mb-1 text-secondary">24H{{ $t('contract.h9') }}（{{ $t('contract.e2') }}）</div>
                <div>
                  {{ activeContract.vol }}
                </div>
              </div>
