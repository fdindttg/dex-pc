        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 mb-4">
            <div class="footer-info-list">
              ...
              <ul>
                <li>
                  <router-link v-if="service[0]" :to="service[0].url">{{ $t("common.aboutUs") }}</router-link>
                </li>
                <li>
                  <router-link v-if="service[1]" :to="service[1].url">{{ $t("common.userProtocol") }}</router-link>
                </li>
                <li>
                  <router-link v-if="service[2]" :to="service[2].url">{{ $t("common.privacyPolicy") }}</router-link>
                </li>
                <li>
                  <router-link v-if="service[3]" :to="service[3].url">{{ $t("common.legalDeclaration") }}</router-link>
                </li>
              </ul>
            </div>
          </div>
