    ...
    <div class="SecondaryNav" :class="{navBarWrap : criticalPos}">
        <div class="SecondaryNavWidth">
            <ul class="SecondaryNavUl">
                <!-- <li class="SecondaryNavList">
                  <router-link v-if="itemList[0]" :to="itemList[0].url" active-class="SecondaryNavActive">{{ $t("common.aboutUs") }}</router-link>
                </li>
                <li class="SecondaryNavList">
                  <router-link v-if="itemList[1]" :to="itemList[1].url" active-class="SecondaryNavActive">{{ $t("common.userProtocol") }}</router-link>
                </li>
                <li class="SecondaryNavList">
                  <router-link v-if="itemList[2]" :to="itemList[2].url" active-class="SecondaryNavActive">{{ $t("common.privacyPolicy") }}</router-link>
                </li>
                <li class="SecondaryNavList">
                  <router-link v-if="itemList[3]" :to="itemList[3].url" active-class="SecondaryNavActive">{{ $t("common.legalDeclaration") }}</router-link>
                </li> -->
